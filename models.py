...
class PersonalRequest(models.Model):
    ...
    full_name = models.CharField(max_length=100, verbose_name="שם מלא", blank=True, null=True)
    id_number = models.CharField(max_length=9, verbose_name="ת.ז", blank=True, null=True)
    course_name = models.CharField(max_length=255,verbose_name="שם הקורס", blank=True, null=True)
    department = models.CharField(max_length=50, verbose_name="מחלקה", blank=True, null=True)
    year = models.CharField(max_length=4, verbose_name="שנה", blank=True, null=True)
    phone_number = models.CharField(max_length=15, verbose_name="טלפון נייד", blank=True, null=True)
    group_type = models.CharField(max_length=10, choices=TYPE_CHOICES, blank=True, null=True)
    email = models.EmailField(verbose_name="כתובת מייל", blank=True, null=True)
