...
urlpatterns = [
    ...
    path('Group_request.html', views.Group_request, name='Group_request'),  
    path('dean_page.html', views.dean_page, name='dean_page'),
    path('Deanlogin.html', views.Deanlogin, name='Deanlogin'),
    path('najah.html', views.najah, name='Najah'),
    ...
    path('contact_Dean.html', views.contact_Dean, name=''), 
    path('home.html', views.home, name='home'),
 
    path('contact_Dean.html', views.contact_Dean, name='contact_Dean'),
